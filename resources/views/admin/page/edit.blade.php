...
<section class="section main-section">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-1 mb-6">
        <form action="{{ route('page.update') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6">
            @csrf
            <div class="card rounded-xl border-2 border-gray-300 shadow-md w-full">
                ...
                <div class="card-content ">
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" name="meta_title" id="metaTitle" class="input" autofocus>
                        </div>
                        <p class="help">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <textarea name="meta_description" id="metaDesc" class="textarea"></textarea>
                        </div>
                        <p class="help">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" name="meta_keywords" id="metaKeywords" class="input">
                        </div>
                        <p class="help">
            ...
            <div class="card rounded-xl border-2 border-gray-300 shadow-md w-full">
                ...
                <div class="card-content ">
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" name="writer_title" id="writerTitle" class="input" autofocus>
                        </div>
                        <p class="help">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <textarea name="writer_content" id="writerContent" class="textarea"></textarea>
                        </div>
                        <p class="help">
            ...
            <div class="card rounded-xl border-2 border-gray-300 shadow-md w-full">
                ...
                <div class="card-content ">
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" name="faqs_title" id="faqsTitle" class="input" autofocus>
                        </div>
                        <p class="help">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <textarea name="faq_content" id="faqContent" class="textarea"></textarea>
                        </div>
                        <p class="help">
            ...
            <div class="card rounded-xl border-2 border-gray-300 shadow-md w-full">
                ...
                <div class="card-content ">
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="text" name="customer_title" id="customerTitle" class="input" autofocus>
                        </div>
                        <p class="help">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <textarea name="customer_content" id="customerContent" class="textarea"></textarea>
                        </div>
                        <p class="help">
